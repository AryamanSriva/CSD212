...
def gamma_transform(image, gamma):
    # Input image is in floating-point format
    image = image.astype(float)
    # Gamma transformation formula
...
# Print the size and intensity range of original image
...
# Display gamma-transformed image
plt.figure(figsize=(10, 10))
